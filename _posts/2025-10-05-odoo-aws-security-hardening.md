...
📥 **[Download: setup-vpc-security-groups.sh](/assets/downloads/setup-vpc-security-groups.sh)**
...
📥 **[Download: setup-network-acls.sh](/assets/downloads/setup-network-acls.sh)**
...
📥 **[Download: setup-iam-roles.sh](/assets/downloads/setup-iam-roles.sh)**
📋 **[IAM Policy Template: odoo-ec2-policy.json](/assets/downloads/odoo-ec2-policy.json)**
...
📥 **[Download: setup-secrets-manager.sh](/assets/downloads/setup-secrets-manager.sh)**
...
**📋 [Download Production Nginx Configuration Template](/assets/downloads/nginx-ssl.conf)**
...
📥 **[Download: setup-ssl-certbot.sh](/assets/downloads/setup-ssl-certbot.sh)**
...
📥 **[Download: setup-cloudwatch-monitoring.sh](/assets/downloads/setup-cloudwatch-monitoring.sh)**
📋 **[CloudWatch Config: cloudwatch-config.json](/assets/downloads/cloudwatch-config.json)**
...
📥 **[Download: setup-guardduty.sh](/assets/downloads/setup-guardduty.sh)**
...
📥 **[Download: incident-response-playbook.sh](/assets/downloads/incident-response-playbook.sh)**
