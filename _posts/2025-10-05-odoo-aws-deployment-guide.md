...
*Quick download: `wget https://ariashaw.com/assets/downloads/odoo-aws-production.conf -O /opt/odoo/odoo.conf`*
...
*Quick install: `sudo wget https://ariashaw.com/assets/downloads/odoo.service -O /etc/systemd/system/odoo.service`*
